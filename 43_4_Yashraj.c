...
Program - Write a C program to roll_no, name , percentange of 5 students using 
		  array of structure and display the records in descending order of 
		  percentange
*/
#include<stdio.h>
...
void main()
{
	...
	//Sorting elements in descending order of percentage
	for(i=0;i<4;i++)
	{
		for(j=0;j<4;j++)
		{
	...
	//Printing data in descending order of percentage
